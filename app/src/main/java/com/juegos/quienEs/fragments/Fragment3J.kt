 ...
 * Use the [Fragment3J.newInstance] factory method to
 * create an instance of this fragment.
 */
class Fragment3J(val nombres: List<String>, private val numJugadores: Int) : Fragment() {
    ...
    override fun onCreateView(
        ...
        val vista = inflater.inflate(R.layout.fragment3j, container, false)
