 ...
 * Use the [Fragment8J.newInstance] factory method to
 * create an instance of this fragment.
 */
class Fragment8J(val nombres: List<String>) : Fragment() {
    ...
    override fun onCreateView(
        ...
        val vista = inflater.inflate(R.layout.fragment8j, container, false)
...
/*    companion object {
         ...
         * @return A new instance of fragment Fragment8J.
         */
