 ...
 * Use the [Fragment9J.newInstance] factory method to
 * create an instance of this fragment.
 */
class Fragment9J(val nombres: List<String>) : Fragment() {
    ...
    override fun onCreateView(
        ...
        val vista = inflater.inflate(R.layout.fragment9j, container, false)
