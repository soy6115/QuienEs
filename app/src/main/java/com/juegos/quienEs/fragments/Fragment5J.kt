 ...
 * Use the [Fragment5J.newInstance] factory method to
 * create an instance of this fragment.
 */
class Fragment5J(val nombres: List<String>) : Fragment() {
    ...
    override fun onCreateView(
        ...
        val vista = inflater.inflate(R.layout.fragment5j, container, false)
