 ...
 * Use the [Fragment10J.newInstance] factory method to
 * create an instance of this fragment.
 */
class Fragment10J(val nombres: List<String>) : Fragment() {
    ...
    override fun onCreateView(
        ...
        val vista = inflater.inflate(R.layout.fragment10j, container, false)
