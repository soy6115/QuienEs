 ...
 * Use the [Fragment4J.newInstance] factory method to
 * create an instance of this fragment.
 */
class Fragment4J(val nombres: List<String>) : Fragment() {
    ...
    override fun onCreateView(
        ...
        val vista = inflater.inflate(R.layout.fragment4j, container, false)
