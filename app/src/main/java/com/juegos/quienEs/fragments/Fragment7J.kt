 ...
 * Use the [Fragment7J.newInstance] factory method to
 * create an instance of this fragment.
 */
class Fragment7J(val nombres: List<String>) : Fragment() {
    ...
    override fun onCreateView(
        ...
        val vista = inflater.inflate(R.layout.fragment7j, container, false)
