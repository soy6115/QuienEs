 ...
 * Use the [Fragment6J.newInstance] factory method to
 * create an instance of this fragment.
 */
class Fragment6J(val nombres: List<String>) : Fragment() {
    ...
    override fun onCreateView(
        ...
        val vista = inflater.inflate(R.layout.fragment6j, container, false)
