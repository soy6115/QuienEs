 ...
 * Use the [Fragment11J.newInstance] factory method to
 * create an instance of this fragment.
 */
class Fragment11J(val nombres: List<String>) : Fragment() {
    ...
    override fun onCreateView(
        ...
        val vista = inflater.inflate(R.layout.fragment11j, container, false)
